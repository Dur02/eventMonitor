...
<body>
    ...
    <div class="index_top clearfix">
		<h3 class="fl title">图谱库分析 >冲突时间线</h3>
	...
	<div style="width: 100%;">
		        ...
		        <div class="col-md-12">
					<div class="col-md-12 mg_t bor">
	                    ...
	                    <div style="margin-left: 3%;margin-right: 8%">
                  				 <select id="select_country"  class="form-control selectCounts"></select>
               			</div>
        ...
        <%-- <div class="row"style="">
         <div class="col-md-12 mg_t ">
            <div class="col-md-10 oneColumChart" style="width:100%;border: 1px solid #CCCCCC;margin: 0px -8px 0 0;border-radius:3px;height:437px;">
                <!--<h3 class="headline first-child"><span class="fa fa-globe"></span></h3>
-->                <div class="col-md-12 map-text" >
                    <h3 class="tx-c">国家冲突时间线 
                    	<div  class="help" onmouseover="showChartInfo(4,this,${moduleCode},${sessionScope.LOGINUSER.roleId})"></div>
                    </h3>
                </div>
                <div style="margin-left: 5%;margin-right: 8%">
                    <select id="select_country"  class="form-control selectCounts">
                    </select>
                </div>
                <div id="country_date_chart" class="amcharts" ></div>
            </div>
			</div>
        </div> --%>
        ...
        <div class="row"> 
		        <div class="col-md-12">
					<div class="col-md-12 mg_t bor">
	                    ...
	                    <div style="margin-left: 3%;margin-right: 8%">
                  				 <select id="select_state"  class="form-control selectCounts"></select>
               			</div>
	                    <div id="state_date_chart" class="amcharts oneColumChart" ></div>
		             </div>
		        </div>	
	     </div>
        <%-- <div class="row"style="">
				<div class="col-md-12 mg_t ">
		            <div class="col-md-10 oneColumChart" style="width:100%;border: 1px solid #CCCCCC;margin: 0px -8px 0 0;border-radius:3px;height:437px;">
		 				<!-- <h3 class="headline first-child"><span class="fa fa-globe"></span></h3>-->
		                <div class="col-md-12 map-text">
		                    <h3 class="tx-c">州省冲突时间线 
		                    	<div  class="help" onmouseover="showChartInfo(5,this,${moduleCode},${sessionScope.LOGINUSER.roleId})"></div>
		                    </h3>
		                </div>
		                <div style="margin-left: 5%;margin-right: 8%">
		                    <select id="select_state" class="form-control selectCounts">
		                    </select>
		                </div>
		                <div id="state_date_chart" class="amcharts"></div>
		            </div>
   				</div>
        </div> --%>
        ...
        <div class="row"> 
		        <div class="col-md-12">
					<div class="col-md-12 mg_t bor">
	                    ...
	                    <div style="margin-left: 3%;margin-right: 8%">
                  				 <select id="select_city"  class="form-control selectCounts"></select>
               			</div>
        ...
        <%-- <div class="row"style="">
            ...
            <div class="col-md-10 oneColumChart" style="width:100%;border: 1px solid #CCCCCC;margin: 0px -8px 0 0;border-radius:3px;height:437px;">
                   <!-- <h3 class="headline first-child"><span class="fa fa-globe"></span></h3>-->
                <div class="col-md-12 map-text">
                    <h3 class="tx-c">城市冲突时间线
                    	<div  class="help" onmouseover="showChartInfo(6,this,${moduleCode},${sessionScope.LOGINUSER.roleId})"></div>
                    </h3>
                </div>
                <div style="margin-left: 5%;margin-right: 8%">
                    <select id="select_city" class="selectCounts form-control">
                    </select>
                </div>
                <div id="city_date_chart" class="amcharts" ></div>
            </div>
			</div>
        </div> --%>
        ...
        <div class="row">
			<div class="col-md-12 mg_t">
	                <div class="col-md-12 map-text">
	                    <h3 class="tx-c mapText_heat_time">国家冲突热点图
	                ...
	                <div class="bor">
	                    ...
	                    <div class="heatTl" id="countryHeat">
		                    <div>
	                        	<span>0</span>
	                        	<img src="<%=basePath %>/static/images/heatTl.png">
	                        	<span id="maxCountryValue">0</span>
	                        </div>
	                    </div>
	                </div>
	        </div>
        ...
        <!-- <div class="row">
			 <div class="col-md-12  ">
			 <div class="col-md-10 " style="width:100%;border: 1px solid #CCCCCC;margin: 16px -8px 0 0;border-radius:3px;height:437px;margin-bottom:70px;">
	                   <h3 class="headline first-child"><span class="fa fa-globe"></span></h3>
	                <div class="col-md-12 map-text">
	                    <h1 style="font-size:14px;">国家冲突热点图</h1>
	                    <input type="text" id="country_date" style="border:0px;text-align: center;margin-top: -3px;margin-bottom: 5px;">
	                    <input type="text" id="country_date_range" style="width:140px;text-align:center; position:absolute; right:84px;">
	                </div>
	                <div class="col-md-12">
	                    <div id="bubble_country" class="ammap" style="height:360px;"></div>
         ...
         <div class="row">
			<div class="col-md-12 mg_t">
	                <div class="col-md-12 map-text">
	                    <h3 class="tx-c mapText_heat_time">州省冲突热点图
	                    	<div  class="help" onmouseover="showChartInfo(8,this,${moduleCode},${sessionScope.LOGINUSER.roleId})"></div>
	                    </h3>
	                     <input type="text" id="state_date" style="border:0px;text-align:center;"readonly="true">
	                </div>
	                <div class="bor">
	                    <div id="bubble_state" class="ammap myleafletjsMap" ></div>
	                    <div style="position: absolute;z-index: 99;right:22px;top: 50px;margin-top: -43px;">
	                    	<div id="btn-group" class="btn-group fr" style="width:110px; margin-left:20px;">
                                 <input type="button" class="borcolor btn" onclick="stateStart()" id="state_start" value="开始">
                                 <input type="button" class="borcolor btn" id="state_stop" value="停止">
                            </div>
                        	<input class="fr" type="text" id="state_date_range" readonly style="width:260px;text-align:center; line-height:35px;">
	                    </div>
        ...
        <!-- <div class="row"style="">
		 <div class="col-md-12  ">
		 <div class="col-md-10 " style="width:100%;border: 1px solid #CCCCCC;margin: -53px -8px 0 0;border-radius:3px;height:437px;margin-bottom:70px;">
                   <h3 class="headline first-child"><span class="fa fa-globe"></span></h3>
                <div class="col-md-12 map-text">
                    <h1 style="font-size:14px;">州省冲突热点图</h1>
                    <input type="text" value="时间" id="state_date" style="border:0px;text-align: center;margin-top: -3px;margin-bottom: 5px;">
                    <input type="text" value="时间范围" id="state_date_range" style="width:140px;text-align:center; position:absolute; right:84px;">
                </div>
                <div class="col-md-12">
                    <div id="bubble_state" class="ammap" style="height:360px;"></div>
                    <div style="position: absolute;z-index: 99;right:100px;top: 5px">
                        <div class="btn-group">
          ...
          <div class="row">
			<div class="col-md-12 mg_t mg_b">
	                <div class="col-md-12 map-text">
	                    <h3 class="tx-c mapText_heat_time">城市冲突热点图
		 ...
		 <div class="col-md-10 " style="width:100%;border: 1px solid #CCCCCC;margin: -53px -8px 0 0;border-radius:3px;height:437px;margin-bottom:70px;">
                ...
                <div class="col-md-12 map-text">
                    ...
                    <input type="text" value="时间范围" id="city_date_range" style="width:140px;text-align:center; position:absolute; right:84px;">
                </div>
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function renderData(data){
    	...
    	if($("#state_start").hasClass("act")){
    		$("#state_start").removeClass("act");
    	}
		...
		if(state_dic.length>0){
			...
			/* if(stateNum==1){
				document.getElementById("selectState").options.add(new Option("1","1"));
			} */
			...
			if(countryOptionCount.indexOf(8)!=-1){
				...
				process_dic_to_pie(state_dic,'pie_chart','pie_chart',8);
			}else{
				$("#selectState").hide();
				process_dic_to_pie(state_dic,'pie_chart','pie_chart',stateNum);
			}
		...
		if(city_dic.length>0){
			...
			if(cityOptionCount.indexOf(6)!=-1){
				...
				process_dic_to_amchart(city_dic,'radar_chart','radar_chart',6);
			}else{
				$("#selectCity").hide();
				process_dic_to_amchart(city_dic,'radar_chart','radar_chart',cityNum);
			}
		...
		var state_line_dic = data.state_line_dic;
        ...
        if(country_line_dic.length>0){
	        ...
	        $("#select_country").change(function() {process_dic_to_datechart(get_needed_date_dic(country_line_dic,$("#select_country").val()),'country_date_chart')});
	        process_dic_to_datechart(get_needed_date_dic(country_line_dic,$("#select_country option:first").val()),'country_date_chart');
        }else{
        	$("#select_country").hide();
        	$("#country_date_chart").html('<img alt="" class="tubiao1"  src="<%=basePath %>/static/images/tubiao2.png">');
        }
        if(state_line_dic.length>0){
        	$("#select_state").show();
	        for (var i = 0; i < dtlen2; i++)
	        {
	            var name=state_dic[i].key.toString();
	            var number=(state_dic[i].value).toString();
	            $("#select_state").append("<option value='"+name+"'>州省："+name+"   冲突总数："+number + "</option>");
	        }
	        $("#select_state").change(function() {process_dic_to_datechart(get_needed_date_dic(state_line_dic,$("#select_state").val()),'state_date_chart')});
	        process_dic_to_datechart(get_needed_date_dic(state_line_dic,$("#select_state option:first").val()),'state_date_chart');
        }else{
        	$("#select_state").hide();
        	$("#state_date_chart").html('<img alt="" class="tubiao1"  src="<%=basePath %>/static/images/tubiao2.png">');
        }
		if(city_line_dic.length>0){
			$("#select_city").show();
        ...
        ///////////////////////////
        maxCountryValue = maxNum.num.split(",")[0];
        $("#maxCountryValue").html(maxCountryValue);
        if(country_timeline_dic!=""){
        	$("#countryHeat").show();
        	$("#country_start").attr("disabled",false);
        	country_data = groupByDate(country_timeline_dic,'country',maxNum.num.split(",")[0]);
	        ...
	        if(date1.length==4){
	        	...
	        	document.getElementById("country_date_range").value = "轮播范围："+date1.slice(0,4)+"年"+"-"+dateTwo.slice(0,4)+"年";
	        }
	        if(date1.length==6){
	        	document.getElementById("country_date").value = date1.slice(0,4)+"年"+date1.slice(4,6)+"月";
	        	document.getElementById("country_date_range").value = "轮播范围："+date1.slice(0,4)+"年"+date1.slice(4,6)+"月"+"-"+dateTwo.slice(0,4)+"年"+dateTwo.slice(4,6)+"月";
	        }
	        if(date1.length==8){
		        document.getElementById("country_date").value = date1.slice(0,4)+"年"+date1.slice(4,6)+"月"+date1.slice(6,8)+"日";
		        document.getElementById("country_date_range").value = "轮播范围："+date1.slice(0,4)+"年"+date1.slice(4,6)+"月"+date1.slice(6,8)+"日"+"-"+dateTwo.slice(0,4)+"年"+dateTwo.slice(4,6)+"月"+dateTwo.slice(6,8)+"日";
	        }
	        process_dic_to_bubblemap3(country_data.get(0), 'bubble_country',maxCountryValue);
        }else{
        	$("#countryHeat").hide();
        	$('#country_start').attr("disabled",true);
        	$("#country_date").val("");
        	$("#country_date_range").val("");
        	process_dic_to_bubblemap3(country_timeline_dic,'bubble_country');//国家
        }
        
        //////////////////////////
        maxStateValue = maxNum.num.split(",")[1];
        $("#maxStateValue").html(maxStateValue);
        if(state_timeline_dic!=""){
        	$("#stateHeat").show();
        	$('#state_start').attr("disabled",false);
        	state_data = groupByDate(state_timeline_dic,'state',maxNum.num.split(",")[1]);
        	len2 = state_data.count;///
        	var date2 = state_data.seq[0];
	        var dateTwo = state_data.seq[len2-1];
	        if(date2.length==4){
	        	document.getElementById("state_date").value = date2.slice(0,4)+"年";
	        	document.getElementById("state_date_range").value = "轮播范围："+date2.slice(0,4)+"年"+"-"+dateTwo.slice(0,4)+"年";
	        }
	        if(date2.length==6){
	        	document.getElementById("state_date").value = date2.slice(0,4)+"年"+date2.slice(4,6)+"月";
	        	document.getElementById("state_date_range").value = "轮播范围："+date2.slice(0,4)+"年"+date2.slice(4,6)+"月"+"-"+dateTwo.slice(0,4)+"年"+dateTwo.slice(4,6)+"月";
	        }
	        if(date2.length==8){
		        document.getElementById("state_date").value = date2.slice(0,4)+"年"+date2.slice(4,6)+"月"+date2.slice(6,8)+"日";
		        document.getElementById("state_date_range").value = "轮播范围："+date2.slice(0,4)+"年"+date2.slice(4,6)+"月"+date2.slice(6,8)+"日"+"-"+dateTwo.slice(0,4)+"年"+dateTwo.slice(4,6)+"月"+dateTwo.slice(6,8)+"日";
	        }
	        process_dic_to_bubblemap3(state_data.get(0), 'bubble_state',maxStateValue);
	        
        }else{
        	$("#stateHeat").hide();
        	$('#state_start').attr("disabled",true);
        	$("#state_date").val("");
        	$("#state_date_range").val("");
        	process_dic_to_bubblemap3(country_timeline_dic,'bubble_state');//州省
        }
        
        /////////////////////////
        maxCityValue = maxNum.num.split(",")[2];
        $("#maxCityValue").html(maxCityValue);
        if(city_timeline_dic!=""){
        	$("#cityHeat").show();
        	$('#city_start').attr("disabled",false);
        	city_data = groupByDate(city_timeline_dic,'city',maxNum.num.split(",")[2]);
        	len3 = city_data.count;///
	        var date3 = city_data.seq[0];
	        var dateTwo = city_data.seq[len3-1];
	        if(date3.length==4){
	        	document.getElementById("city_date").value = date3.slice(0,4)+"年";
	        	document.getElementById("city_date_range").value = "轮播范围："+date3.slice(0,4)+"年"+"-"+dateTwo.slice(0,4)+"年";
	        }
	        if(date3.length==6){
	        	document.getElementById("city_date").value = date3.slice(0,4)+"年"+date3.slice(4,6)+"月";
	        	document.getElementById("city_date_range").value = "轮播范围："+date3.slice(0,4)+"年"+date3.slice(4,6)+"月"+"-"+dateTwo.slice(0,4)+"年"+dateTwo.slice(4,6)+"月";
	        }
	        if(date3.length==8){
		        document.getElementById("city_date").value = date3.slice(0,4)+"年"+date3.slice(4,6)+"月"+date3.slice(6,8)+"日";
		        document.getElementById("city_date_range").value = "轮播范围："+date3.slice(0,4)+"年"+date3.slice(4,6)+"月"+date3.slice(6,8)+"日"+"-"+dateTwo.slice(0,4)+"年"+dateTwo.slice(4,6)+"月"+dateTwo.slice(6,8)+"日";
	        }
        	...
        	$("#city_date").val("");
        	$("#city_date_range").val("");
        	process_dic_to_bubblemap3(country_timeline_dic,'bubble_city');//城市
        }
        ...
        function groupByDate(data,type,num) {
            var ret = {values: {}, seq:[]};
            var minValue, maxValue;
            var num2 = parseInt(num/4);
            data.forEach(function(e) {
                ...
                if (type=='country'){
                    c = {
                        ...
                        long: e.long,
                        key: e.name_key,
                        color: e.value > num2*3 ? 'red' : (e.value > num2*2 ? '#ff4500' : (e.value > num2*1 ? 'green' : 'limegreen')),
                        value: e.value
                    };
                }
                else if (type=='state'){
                    c = {
               		...
               		c = {
                         ...
                         long: e.long,
                         key: e.name_key,
                         color: e.value > num2*2 ? 'red' : (e.value > num2*1 ? '#ff4500' : (e.value > num2/2 ? 'green' : 'limegreen')),
                         value: e.value
                        };
                }
    	...
    	var pos1 = 0;
           ...
           countryPlay = setInterval(function(){
               if(pos1==len1){// 到了最后一个则又重复执行
                   ...
                   process_dic_to_bubblemap3(country_data.get(pos1), 'bubble_country',maxCountryValue);
                   pos1++;
               }
           },1000);// 每1秒执行一次
        ...
        var pos2 = 0;
          ...
          statePlay = setInterval(function(){
              if(pos2==len2){// 到了最后一个则又重复执行
                  ...
                  process_dic_to_bubblemap3(state_data.get(pos2), 'bubble_state',maxStateValue);
                  pos2++;
              }
          },1000);// 每1秒执行一次

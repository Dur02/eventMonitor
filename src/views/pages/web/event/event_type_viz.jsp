...
<%-- <link rel="stylesheet" href="<%=basePath%>/static/Visualization/css/typemap.css" type="text/css" media="screen" /> --%>
<!-- 两种皮肤切换 -->
...
<body>
	<div class="index_top clearfix">
		<h3 class="fl title">事件库分析 > 类型展示</h3>
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><img class="gq" src="<%=basePath%>/static/images/gq2.png"
							alt="挂起"></td>
						<td>南海多国热点</td>
						<td>事件对比分析</td>
						<td>admin</td>
...
<script type="text/javascript">
        ...
        function render(configId){
        	startLoad();
			$.ajax({
				url:'<%=basePath%>/search/event_type_viz/'+configId,
				type: 'POST',
				dataType:"json",
        ...
        function renderData(data){
    		...
    		if (controlLayer != null) {
             ...
             var root = data.quadclass_dic;
             var base = data.eventrootcode;
             var event_dic = data.result1;
             var scale_dic = data.result2;
 			 var max_sum = data.maxQuad; 
             var max_scale = data.maxRoot;
             ...
             if(flag){
            	 pie_chart('graph_root',root);
             }else{
             	$("#graph_root").html('<img alt="" class="tubiao2"  src="<%=basePath %>/static/images/tubiao2.png">');
             }
             var flag1 = false;
             for(var i in base){
             	if(base[i].value!=0){
             ...
             if(flag1){
            	 pie_chart('graph_base',base);
             }else{
             	$("#graph_base").html('<img alt="" class="tubiao2"  src="<%=basePath %>/static/images/tubiao2.png">');
             }

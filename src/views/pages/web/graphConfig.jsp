					...
					<div class="high_search_con" style="margin-top: 30px;">
						<ul class="tab_down_info">
							...
							<div class="date_box clearfix">
								...
								<div style="position:absolute; left:140px; top:-20px" id="dateRange">当前数据库时间范围：<span id="stDateSpan"></span>至<span id="edDateSpan"></span></div>
							...
							<li class="clearfix" id="dataSourceType">
								...
								<div class="td5_event fl"><input class="dataSourceType dataSourceType1" type="radio" id="radios1" name="dataSourceType" checked="checked" value="1"><label for="radios1"> 数据源一</label></div>
								<div class="td5_event fl"><input class="dataSourceType dataSourceType2" type="radio" id="radios2" name="dataSourceType" value="2"><label for="radios2"> 数据源二</label></div>
								<div class="td5_event fl"><input class="dataSourceType dataSourceType3" type="radio" id="radios3" name="dataSourceType" value="3"><label for="radios3"> 数据源三</label></div>
							</li>
							<!-- 权重依据 -->
							<li class="clearfix" id="quanzhong2">
							...
							<li class="clearfix" id="bizhong" style="display: none;">
								...
								<div class="td5_event fl"><input class="tjradio1" type="radio" id="tjradio1" name="valueWeight" checked="checked" value="1"><label for="tjradio1"> 比重</label></div>
								<div class="td5_event fl"><input class="tjradio2" type="radio" id="tjradio2" name="valueWeight" value="2"><label for="tjradio2"> 数量</label></div>
							</li>
							<div class="ulli">
						   <li class="clearfix keyWords">
						   ...
						   <li class="clearfix keyWords">
								<div class="td1 fl"><p class="threshold_them_png fl"></p><b style="line-height:15px;">主题搜索：</b></div>
								<div class="radio_box">
						   ...
						   <li class="clearfix keyWords">
								<div class="td1 fl"><p class="threshold_geo_png fl"></p><b style="line-height:15px;">地理搜索：</b></div>
								<div class="radio_box">
						   ...
						   <li class="clearfix keyWords">
								<div class="td1 fl"><p class="threshold_person_png fl"></p><b style="line-height:15px;">人物搜索：</b></div>
								<div class="radio_box">
						   ...
						   <li class="clearfix keyWords">
								<div class="td1 fl"><p class="threshold_org_png fl"></p><b style="line-height:15px;">组织搜索：</b></div>
								<div class="radio_box">
						   ...
						   <li class="clearfix keyWords">
								<div class="td1 fl"><p class="threshold_web_png fl"></p><b style="line-height:15px;">网站地域：</b></div>
								<div><!-- 这个空div不能删除，必须保留 -->
							...
							<!-- 权重范围 -->
							<li class="clearfix" id="baodaoshu" style="display:none;    margin-top: 5px">
							...
							<li class="clearfix"><input class="submit" type="button" onclick="gkgSub(1);" value="提交" id="scheduleState1"></li>
						</div>
						</ul>
						<div class="test_triangle_border property_case">
					        <div class="popup1 case_con">
								...
								<textarea class="texthtml" id="customQuery" name="customQuery"  placeholder="内容可以参考案例SQL"></textarea>
...
function addConfig(string){
	...
	if(string != 'two'){
		//默认数据源一点击
		setTimeout(function(){$(".dataSourceType1").click();},1000);
	}
	$("#dateRange").show();
	$("#dataSourceType").show();
...
/* 事件,图谱类型多选、保存、取消 */
  ...
  //   -------------------------------------------------------------
	...
	function save_atlas(){
		...
		if(atlas_typeId_str.indexOf("16")!=-1 && atlas_typeId_str.length==2){//人物监测(态势)
			$('.property_case').hide();
			$('#dataSourceType').hide();
			$('.high_search').hide();
			$("#bizhong").hide();
	...
	//获取图谱配置的三套数据源的日期范围
	function findGkgConfigDateRange(){
		$.ajax({
			url:'../config/findGkgConfigDateRange',
			type:'post',
			dataType:"json",
			success:function(data){
				//提示开始和结束时间赋值

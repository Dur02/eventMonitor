...
var colorMapContinent = {
	Africa: '#1abc9c',
	Americas: '#9b59b6',
	Antarctica: '#3498db',
	Asia: '#27ae60',
	'Atlantic Ocean': '#34495e',
	Europe: '#f39c12',
	'Indian Ocean': '#e74c3c',
	Oceania: '#8AC7CC'
};
...
var colorMapRegion = {
	'Southern Africa': '#5DCCCC',
	'Northern Africa': '#CCC393',
	'South Atlantic Ocean': '#998418',
	Antarctica: '#FFD68E',
	'Indian Ocean': '#CDF2FF',
	'West Indies': '#C2CC47',
	'Southern Europe': '#CC827E',
	'Central Asia': '#998382',
	'North America': '#FF73E7',
	'South Asia': '#DFFFB3',
	'Western Africa': '#CC4E4B',
	'Western Europe': '#81ACCC',
	'North Pacific Ocean': '#859099',
	'South East Asia': '#77FFF0',
	'Central America': '#FFC3B7',
	'Northern Europe': '#3A52CC',
	' Region': '#9ACC70',
	'Southern Indian Ocean': '#879978',
	'Central Europe': '#FFF862',
	'Central Africa': '#7BCCBF',
	Pacific: '#CCBA7B',
	'Eastern Africa': '#99866B',
	'South East Europe': '#FFDF6D',
	'South America': '#8BA3A6',
	'South West Asia': '#AACC7B',
	'Northern Asia': '#CC8A7B',
	'East Asia': '#5A90CC',
	'Eastern Europe': '#539999',
	'South West Europe': '#A66E5E'
};

function buildBubbleMap(mapData, domId) {
	for (var i = 0; i < mapData.length; i++) {
			var v = mapData[i].value;
			if (v < min) {
				min = v;
			}
			if (v > max) {
		...
		map.path = "/static/Visualization/js/amcharts/";
	//	map.addTitle("2014年世界政治稳定性一览", 14);
	//	map.addTitle("source: Gapminder", 11);
		...
		for (i = 0; i < mapData.length; i++) {
			...
			if (latlong[id]) { // sometime can't find it
